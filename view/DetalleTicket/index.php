...
?>
    ...
    <head lang="es">
        <title>Ciberjose - Detalle Ticket</title>
        <?php
            ...
            <div class="container-fluid">
                ...
                <div class="box-typical box-typical-padding">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <fieldset class="form-group">
                                <label class="form-label semibold" for="subc_nom">SubCategoria</label>
                        ...
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <label class="form-label semibold" for="tick_descripusu">Descripción</label>
                                <div class="summernote-theme-1">
                                    <textarea id="tick_descripusu" name="tick_descripusu" class="summernote" name="name" readonly></textarea>
                                </div>
                ...
                <section class="activity-lain" id="lbldetalle">
                ...
                <div class="box-typical box-typical-padding" id="pnldetalle">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <label class="form-label semibold" for="descrip_duda">Descripción</label>
                                <div class="summernote-theme-1">
                                    <textarea id="descrip_duda" name="descrip_duda" class="summernote" name="name"></textarea>
                                </div>
                            </fieldset>
                        </div>
